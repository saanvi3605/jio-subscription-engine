...
public class BillingAccountRef {
  ...
  public BillingAccountRef ratingType(@Nullable String ratingType) {
  ...
  @Schema(name = "ratingType", description = "Indicates whether the account follows a specific payment option such as prepaid or postpaid", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("ratingType")
  public @Nullable String getRatingType() {
    return ratingType;
  }

  @JsonProperty("ratingType")
  public void setRatingType(@Nullable String ratingType) {
    this.ratingType = ratingType;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, name, ratingType, atBaseType, atSchemaLocation, atType, atReferredType);
  }
