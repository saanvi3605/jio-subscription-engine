...
import org.openapitools.model.ProductOfferingPriceDeleteEventPayload;
...
@Schema(name = "ProductOfferingPriceDeleteEvent", description = "The notification data structure")
...
public class ProductOfferingPriceDeleteEvent {
  ...
  private @Nullable ProductOfferingPriceDeleteEventPayload event;

  public ProductOfferingPriceDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOfferingPriceDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingPriceDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingPriceDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingPriceDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingPriceDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingPriceDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingPriceDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingPriceDeleteEvent description(@Nullable String description) {
  ...
  public ProductOfferingPriceDeleteEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingPriceDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingPriceDeleteEvent event(@Nullable ProductOfferingPriceDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingPriceDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingPriceDeleteEventPayload event) {
    this.event = event;
  }
