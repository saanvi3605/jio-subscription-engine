...
@Schema(name = "ProductOffering_Update", description = "Represents entities that are orderable from the provider of the catalog, this resource includes pricing information. Skipped properties: id,href,lastUpdate")
...
public class ProductOfferingUpdate {
  ...
  public ProductOfferingUpdate description(@Nullable String description) {
  ...
  public ProductOfferingUpdate isBundle(@Nullable Boolean isBundle) {
  ...
  public ProductOfferingUpdate isSellable(@Nullable Boolean isSellable) {
  ...
  public ProductOfferingUpdate lifecycleStatus(@Nullable String lifecycleStatus) {
  ...
  public ProductOfferingUpdate name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductOfferingUpdate statusReason(@Nullable String statusReason) {
  ...
  public ProductOfferingUpdate version(@Nullable String version) {
  ...
  public ProductOfferingUpdate productOfferingPrice(List<@Valid ProductOfferingPriceRef> productOfferingPrice) {
  ...
  public ProductOfferingUpdate productSpecification(@Nullable ProductSpecificationRef productSpecification) {
  ...
  public ProductOfferingUpdate resourceCandidate(@Nullable ResourceCandidateRef resourceCandidate) {
  ...
  public ProductOfferingUpdate serviceCandidate(@Nullable ServiceCandidateRef serviceCandidate) {
  ...
  public ProductOfferingUpdate serviceLevelAgreement(@Nullable SLARef serviceLevelAgreement) {
  ...
  public ProductOfferingUpdate validFor(@Nullable TimePeriod validFor) {
  ...
  public ProductOfferingUpdate atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOfferingUpdate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOfferingUpdate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, productOfferingUpdate.description) &&
        ...
        Objects.equals(this.atBaseType, productOfferingUpdate.atBaseType) &&
        Objects.equals(this.atSchemaLocation, productOfferingUpdate.atSchemaLocation) &&
        Objects.equals(this.atType, productOfferingUpdate.atType);
  }
