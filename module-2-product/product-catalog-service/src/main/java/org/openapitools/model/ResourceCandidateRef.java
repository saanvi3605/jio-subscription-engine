...
public class ResourceCandidateRef {
   ...
   */
  @NotNull 
  @Schema(name = "id", description = "Unique identifier of the resource candidate", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  @Schema(name = "href", description = "Reference of the resource candidate", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
  ...
  @Schema(name = "name", description = "Name of the resource candidate", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  @Schema(name = "version", description = "Version of the resource candidate", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public ResourceCandidateRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ResourceCandidateRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
