...
public class CategoryCreate {
  ...
  public CategoryCreate description(@Nullable String description) {
  ...
  public CategoryCreate isRoot(@Nullable Boolean isRoot) {
    this.isRoot = isRoot;
    return this;
  }
  ...
  public CategoryCreate lastUpdate(@Nullable OffsetDateTime lastUpdate) {
  ...
  public CategoryCreate lifecycleStatus(@Nullable String lifecycleStatus) {
  ...
  public CategoryCreate parentId(@Nullable String parentId) {
  ...
  public CategoryCreate version(@Nullable String version) {
  ...
  public CategoryCreate validFor(@Nullable TimePeriod validFor) {
  ...
  public CategoryCreate atBaseType(@Nullable String atBaseType) {
  ...
  public CategoryCreate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public CategoryCreate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
