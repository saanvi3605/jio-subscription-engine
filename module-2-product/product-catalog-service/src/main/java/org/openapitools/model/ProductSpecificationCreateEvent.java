...
import org.openapitools.model.ProductSpecificationCreateEventPayload;
...
@Schema(name = "ProductSpecificationCreateEvent", description = "The notification data structure")
...
public class ProductSpecificationCreateEvent {
  ...
  private @Nullable ProductSpecificationCreateEventPayload event;

  public ProductSpecificationCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductSpecificationCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductSpecificationCreateEvent eventId(@Nullable String eventId) {
  ...
  public ProductSpecificationCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductSpecificationCreateEvent eventType(@Nullable String eventType) {
  ...
  public ProductSpecificationCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductSpecificationCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductSpecificationCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductSpecificationCreateEvent description(@Nullable String description) {
  ...
  public ProductSpecificationCreateEvent priority(@Nullable String priority) {
  ...
  public ProductSpecificationCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductSpecificationCreateEvent event(@Nullable ProductSpecificationCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductSpecificationCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductSpecificationCreateEventPayload event) {
    this.event = event;
  }
