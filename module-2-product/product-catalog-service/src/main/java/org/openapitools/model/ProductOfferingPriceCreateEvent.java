...
import org.openapitools.model.ProductOfferingPriceCreateEventPayload;
...
@Schema(name = "ProductOfferingPriceCreateEvent", description = "The notification data structure")
...
public class ProductOfferingPriceCreateEvent {
  ...
  private @Nullable ProductOfferingPriceCreateEventPayload event;

  public ProductOfferingPriceCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOfferingPriceCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingPriceCreateEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingPriceCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingPriceCreateEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingPriceCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingPriceCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingPriceCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingPriceCreateEvent description(@Nullable String description) {
  ...
  public ProductOfferingPriceCreateEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingPriceCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingPriceCreateEvent event(@Nullable ProductOfferingPriceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingPriceCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingPriceCreateEventPayload event) {
    this.event = event;
  }
