...
@Entity
@Table(name = "product_offering_term")
...
public class ProductOfferingTerm {
  ...
  public ProductOfferingTerm description(@Nullable String description) {
  ...
  public ProductOfferingTerm name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductOfferingTerm duration(@Nullable Quantity duration) {
  ...
  public ProductOfferingTerm validFor(@Nullable TimePeriod validFor) {
  ...
  public ProductOfferingTerm atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOfferingTerm atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOfferingTerm atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
