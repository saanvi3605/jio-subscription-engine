...
public class ProductOfferingAttributeValueChangeEvent {
  ...
  private @Nullable ProductOfferingAttributeValueChangeEventPayload event;

  public ProductOfferingAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public ProductOfferingAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingAttributeValueChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingAttributeValueChangeEvent fieldPath(@Nullable String fieldPath) {
  ...
  public ProductOfferingAttributeValueChangeEvent event(@Nullable ProductOfferingAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingAttributeValueChangeEventPayload event) {
    this.event = event;
  }
