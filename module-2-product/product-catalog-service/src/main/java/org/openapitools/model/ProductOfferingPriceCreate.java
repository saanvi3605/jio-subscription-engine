...
public class ProductOfferingPriceCreate {
  ...
  public ProductOfferingPriceCreate description(@Nullable String description) {
  ...
  public ProductOfferingPriceCreate isBundle(@Nullable Boolean isBundle) {
  ...
  public ProductOfferingPriceCreate lastUpdate(@Nullable OffsetDateTime lastUpdate) {
  ...
  public ProductOfferingPriceCreate lifecycleStatus(@Nullable String lifecycleStatus) {
  ...
  public ProductOfferingPriceCreate percentage(@Nullable Float percentage) {
  ...
  public ProductOfferingPriceCreate priceType(@Nullable String priceType) {
  ...
  public ProductOfferingPriceCreate recurringChargePeriodLength(@Nullable Integer recurringChargePeriodLength) {
  ...
  public ProductOfferingPriceCreate recurringChargePeriodType(@Nullable String recurringChargePeriodType) {
  ...
  public ProductOfferingPriceCreate version(@Nullable String version) {
  ...
  public ProductOfferingPriceCreate price(@Nullable Money price) {
    this.price = price;
    return this;
  }
  ...
  public ProductOfferingPriceCreate unitOfMeasure(@Nullable Quantity unitOfMeasure) {
  ...
  public ProductOfferingPriceCreate validFor(@Nullable TimePeriod validFor) {
  ...
  public ProductOfferingPriceCreate atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOfferingPriceCreate atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public ProductOfferingPriceCreate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
