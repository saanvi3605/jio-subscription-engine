...
import org.openapitools.model.CatalogBatchEventPayload;
...
@Schema(name = "CatalogBatchEvent", description = "The notification data structure")
...
public class CatalogBatchEvent {
  ...
  private @Nullable CatalogBatchEventPayload event;

  public CatalogBatchEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CatalogBatchEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CatalogBatchEvent eventId(@Nullable String eventId) {
  ...
  public CatalogBatchEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CatalogBatchEvent eventType(@Nullable String eventType) {
  ...
  public CatalogBatchEvent correlationId(@Nullable String correlationId) {
  ...
  public CatalogBatchEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CatalogBatchEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CatalogBatchEvent description(@Nullable String description) {
  ...
  public CatalogBatchEvent priority(@Nullable String priority) {
  ...
  public CatalogBatchEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public CatalogBatchEvent event(@Nullable CatalogBatchEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CatalogBatchEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable CatalogBatchEventPayload event) {
    this.event = event;
  }
