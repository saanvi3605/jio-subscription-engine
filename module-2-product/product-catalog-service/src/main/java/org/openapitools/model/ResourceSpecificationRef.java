...
public class ResourceSpecificationRef {
   ...
   */
  @NotNull 
  @Schema(name = "id", description = "Unique identifier of the resource specification", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  @Schema(name = "href", description = "Reference of the resource specification", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
  ...
  @Schema(name = "name", description = "Name of the requiredResourceSpecification", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
