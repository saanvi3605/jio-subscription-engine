...
public class ExportJobCreate {
   ...
   */
  public ExportJobCreate(String url) {
    this.url = url;
  }

  public ExportJobCreate completionDate(@Nullable OffsetDateTime completionDate) {
  ...
  public ExportJobCreate contentType(@Nullable String contentType) {
  ...
  public ExportJobCreate creationDate(@Nullable OffsetDateTime creationDate) {
  ...
  public ExportJobCreate errorLog(@Nullable String errorLog) {
  ...
  public ExportJobCreate path(@Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ExportJobCreate query(@Nullable String query) {
    this.query = query;
    return this;
  }
  ...
  public ExportJobCreate status(@Nullable JobStateType status) {
    this.status = status;
    return this;
  }
  ...
  public ExportJobCreate atBaseType(@Nullable String atBaseType) {
  ...
  public ExportJobCreate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ExportJobCreate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
