...
import org.openapitools.model.CategoryDeleteEventPayload;
...
@Schema(name = "CategoryDeleteEvent", description = "The notification data structure")
...
public class CategoryDeleteEvent {
  ...
  private @Nullable CategoryDeleteEventPayload event;

  public CategoryDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CategoryDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CategoryDeleteEvent eventId(@Nullable String eventId) {
  ...
  public CategoryDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CategoryDeleteEvent eventType(@Nullable String eventType) {
  ...
  public CategoryDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public CategoryDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CategoryDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CategoryDeleteEvent description(@Nullable String description) {
  ...
  public CategoryDeleteEvent priority(@Nullable String priority) {
  ...
  public CategoryDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public CategoryDeleteEvent event(@Nullable CategoryDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CategoryDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable CategoryDeleteEventPayload event) {
    this.event = event;
  }
