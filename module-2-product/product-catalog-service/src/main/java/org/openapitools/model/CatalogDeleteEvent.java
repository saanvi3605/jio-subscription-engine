...
import org.openapitools.model.CatalogDeleteEventPayload;
...
@Schema(name = "CatalogDeleteEvent", description = "The notification data structure")
...
public class CatalogDeleteEvent {
  ...
  private @Nullable CatalogDeleteEventPayload event;

  public CatalogDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CatalogDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CatalogDeleteEvent eventId(@Nullable String eventId) {
  ...
  public CatalogDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CatalogDeleteEvent eventType(@Nullable String eventType) {
  ...
  public CatalogDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public CatalogDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CatalogDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CatalogDeleteEvent description(@Nullable String description) {
  ...
  public CatalogDeleteEvent priority(@Nullable String priority) {
  ...
  public CatalogDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public CatalogDeleteEvent event(@Nullable CatalogDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CatalogDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable CatalogDeleteEventPayload event) {
    this.event = event;
  }
