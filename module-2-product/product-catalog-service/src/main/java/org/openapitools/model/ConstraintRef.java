...
public class ConstraintRef {
   ...
   */
  @NotNull 
  @Schema(name = "id", description = "reference id to the target constraint", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  @Schema(name = "href", description = "Hyperlink reference to the target constraint", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
  ...
  @Schema(name = "name", description = "Name given to the constraint", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  @Schema(name = "@referredType", description = "The (class) type of the referred constraint", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
