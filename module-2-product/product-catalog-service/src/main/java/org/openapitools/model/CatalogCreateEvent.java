...
import org.openapitools.model.CatalogCreateEventPayload;
...
@Schema(name = "CatalogCreateEvent", description = "The notification data structure")
...
public class CatalogCreateEvent {
  ...
  private @Nullable CatalogCreateEventPayload event;

  public CatalogCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CatalogCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CatalogCreateEvent eventId(@Nullable String eventId) {
  ...
  public CatalogCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CatalogCreateEvent eventType(@Nullable String eventType) {
  ...
  public CatalogCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public CatalogCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CatalogCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CatalogCreateEvent description(@Nullable String description) {
  ...
  public CatalogCreateEvent priority(@Nullable String priority) {
  ...
  public CatalogCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public CatalogCreateEvent event(@Nullable CatalogCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CatalogCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable CatalogCreateEventPayload event) {
    this.event = event;
  }
