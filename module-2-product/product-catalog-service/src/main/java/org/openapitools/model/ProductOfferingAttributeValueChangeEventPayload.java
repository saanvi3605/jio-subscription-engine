...
@Schema(name = "ProductOfferingAttributeValueChangeEventPayload", description = "The event data structure")
...
public class ProductOfferingAttributeValueChangeEventPayload {
  ...
  public ProductOfferingAttributeValueChangeEventPayload productOffering(@Nullable ProductOffering productOffering) {
