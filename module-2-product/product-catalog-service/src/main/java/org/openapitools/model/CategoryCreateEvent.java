...
import org.openapitools.model.CategoryCreateEventPayload;
...
@Schema(name = "CategoryCreateEvent", description = "The notification data structure")
...
public class CategoryCreateEvent {
  ...
  private @Nullable CategoryCreateEventPayload event;

  public CategoryCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CategoryCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CategoryCreateEvent eventId(@Nullable String eventId) {
  ...
  public CategoryCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CategoryCreateEvent eventType(@Nullable String eventType) {
  ...
  public CategoryCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public CategoryCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CategoryCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CategoryCreateEvent description(@Nullable String description) {
  ...
  public CategoryCreateEvent priority(@Nullable String priority) {
  ...
  public CategoryCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public CategoryCreateEvent event(@Nullable CategoryCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CategoryCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable CategoryCreateEventPayload event) {
    this.event = event;
  }
