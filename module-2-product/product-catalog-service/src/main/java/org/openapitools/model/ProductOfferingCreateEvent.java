...
import org.openapitools.model.ProductOfferingCreateEventPayload;
...
@Schema(name = "ProductOfferingCreateEvent", description = "The notification data structure")
...
public class ProductOfferingCreateEvent {
  ...
  private @Nullable ProductOfferingCreateEventPayload event;

  public ProductOfferingCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOfferingCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingCreateEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingCreateEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingCreateEvent description(@Nullable String description) {
  ...
  public ProductOfferingCreateEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingCreateEvent event(@Nullable ProductOfferingCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingCreateEventPayload event) {
    this.event = event;
  }
