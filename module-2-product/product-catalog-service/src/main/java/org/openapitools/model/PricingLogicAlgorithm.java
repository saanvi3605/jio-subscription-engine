...
@Entity
@Table(name = "pricing_logic_algorithm")
...
public class PricingLogicAlgorithm {
  ...
  private @Nullable String plaSpecId;
  ...
  public PricingLogicAlgorithm id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  @Schema(name = "id", description = "unique id of the PricingLogicAlgorithm", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  ...
  public PricingLogicAlgorithm href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  @Schema(name = "href", description = "hyperlink reference of this PricingLogicAlgorithm", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
  ...
  public PricingLogicAlgorithm description(@Nullable String description) {
  ...
  public PricingLogicAlgorithm name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PricingLogicAlgorithm plaSpecId(@Nullable String plaSpecId) {
  ...
  public @Nullable String getPlaSpecId() {
    return plaSpecId;
  }

  @JsonProperty("plaSpecId")
  public void setPlaSpecId(@Nullable String plaSpecId) {
    this.plaSpecId = plaSpecId;
  }

  public PricingLogicAlgorithm validFor(@Nullable TimePeriod validFor) {
  ...
  public PricingLogicAlgorithm atBaseType(@Nullable String atBaseType) {
  ...
  public PricingLogicAlgorithm atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public PricingLogicAlgorithm atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
