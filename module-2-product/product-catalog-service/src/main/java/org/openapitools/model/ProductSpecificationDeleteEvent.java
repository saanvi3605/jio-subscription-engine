...
public class ProductSpecificationDeleteEvent {
  ...
  private @Nullable ProductSpecificationDeleteEventPayload event;

  public ProductSpecificationDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductSpecificationDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductSpecificationDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ProductSpecificationDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductSpecificationDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ProductSpecificationDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductSpecificationDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductSpecificationDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductSpecificationDeleteEvent description(@Nullable String description) {
  ...
  public ProductSpecificationDeleteEvent priority(@Nullable String priority) {
  ...
  public ProductSpecificationDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductSpecificationDeleteEvent event(@Nullable ProductSpecificationDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductSpecificationDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductSpecificationDeleteEventPayload event) {
    this.event = event;
  }
