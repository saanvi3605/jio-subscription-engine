...
public class ProductOfferingStateChangeEvent {
  ...
  private @Nullable ProductOfferingStateChangeEventPayload event;

  public ProductOfferingStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOfferingStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingStateChangeEvent description(@Nullable String description) {
  ...
  public ProductOfferingStateChangeEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingStateChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingStateChangeEvent event(@Nullable ProductOfferingStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingStateChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingStateChangeEventPayload event) {
    this.event = event;
  }
