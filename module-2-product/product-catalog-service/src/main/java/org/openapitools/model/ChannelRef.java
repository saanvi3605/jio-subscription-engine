...
public class ChannelRef {
  ...
  public ChannelRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ChannelRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ChannelRef atBaseType(@Nullable String atBaseType) {
  ...
  public ChannelRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ChannelRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ChannelRef atReferredType(@Nullable String atReferredType) {
