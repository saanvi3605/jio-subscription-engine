...
public class CatalogCreate {
  ...
  public CatalogCreate catalogType(@Nullable String catalogType) {
  ...
  public CatalogCreate description(@Nullable String description) {
  ...
  public CatalogCreate lastUpdate(@Nullable OffsetDateTime lastUpdate) {
  ...
  public CatalogCreate lifecycleStatus(@Nullable String lifecycleStatus) {
  ...
  public CatalogCreate version(@Nullable String version) {
  ...
  public CatalogCreate validFor(@Nullable TimePeriod validFor) {
  ...
  public CatalogCreate atBaseType(@Nullable String atBaseType) {
  ...
  public CatalogCreate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public CatalogCreate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
