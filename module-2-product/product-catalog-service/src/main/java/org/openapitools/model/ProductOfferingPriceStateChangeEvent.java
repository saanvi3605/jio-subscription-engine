...
import org.openapitools.model.ProductOfferingPriceStateChangeEventPayload;
...
@Schema(name = "ProductOfferingPriceStateChangeEvent", description = "The notification data structure")
...
public class ProductOfferingPriceStateChangeEvent {
  ...
  private @Nullable ProductOfferingPriceStateChangeEventPayload event;

  public ProductOfferingPriceStateChangeEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOfferingPriceStateChangeEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingPriceStateChangeEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingPriceStateChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingPriceStateChangeEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingPriceStateChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingPriceStateChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingPriceStateChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingPriceStateChangeEvent description(@Nullable String description) {
  ...
  public ProductOfferingPriceStateChangeEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingPriceStateChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingPriceStateChangeEvent event(@Nullable ProductOfferingPriceStateChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingPriceStateChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingPriceStateChangeEventPayload event) {
    this.event = event;
  }
