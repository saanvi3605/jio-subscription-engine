...
import org.openapitools.model.ProductOfferingPriceAttributeValueChangeEventPayload;
...
@Schema(name = "ProductOfferingPriceAttributeValueChangeEvent", description = "The notification data structure")
...
public class ProductOfferingPriceAttributeValueChangeEvent {
  ...
  private @Nullable ProductOfferingPriceAttributeValueChangeEventPayload event;

  public ProductOfferingPriceAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingPriceAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingPriceAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent fieldPath(@Nullable String fieldPath) {
  ...
  public ProductOfferingPriceAttributeValueChangeEvent event(@Nullable ProductOfferingPriceAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingPriceAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingPriceAttributeValueChangeEventPayload event) {
    this.event = event;
  }
