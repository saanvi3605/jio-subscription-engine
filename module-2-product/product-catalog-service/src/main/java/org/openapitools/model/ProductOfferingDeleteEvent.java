...
import org.openapitools.model.ProductOfferingDeleteEventPayload;
...
@Schema(name = "ProductOfferingDeleteEvent", description = "The notification data structure")
...
public class ProductOfferingDeleteEvent {
  ...
  private @Nullable ProductOfferingDeleteEventPayload event;

  public ProductOfferingDeleteEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOfferingDeleteEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingDeleteEvent eventId(@Nullable String eventId) {
  ...
  public ProductOfferingDeleteEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOfferingDeleteEvent eventType(@Nullable String eventType) {
  ...
  public ProductOfferingDeleteEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOfferingDeleteEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOfferingDeleteEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOfferingDeleteEvent description(@Nullable String description) {
  ...
  public ProductOfferingDeleteEvent priority(@Nullable String priority) {
  ...
  public ProductOfferingDeleteEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOfferingDeleteEvent event(@Nullable ProductOfferingDeleteEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOfferingDeleteEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOfferingDeleteEventPayload event) {
    this.event = event;
  }
