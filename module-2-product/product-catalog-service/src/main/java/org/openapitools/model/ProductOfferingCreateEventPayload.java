...
@Schema(name = "ProductOfferingCreateEventPayload", description = "The event data structure")
...
public class ProductOfferingCreateEventPayload {
  ...
  public ProductOfferingCreateEventPayload productOffering(@Nullable ProductOffering productOffering) {
