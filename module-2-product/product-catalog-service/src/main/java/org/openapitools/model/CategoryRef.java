...
@Schema(name = "CategoryRef", description = "The category for grouping recommendations")
...
public class CategoryRef {
  ...
  public CategoryRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CategoryRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CategoryRef version(@Nullable String version) {
  ...
  public CategoryRef atBaseType(@Nullable String atBaseType) {
  ...
  public CategoryRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public CategoryRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public CategoryRef atReferredType(@Nullable String atReferredType) {
