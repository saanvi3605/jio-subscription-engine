...
public class MarketSegmentRef {
  ...
  public MarketSegmentRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public MarketSegmentRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MarketSegmentRef atBaseType(@Nullable String atBaseType) {
  ...
  public MarketSegmentRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public MarketSegmentRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public MarketSegmentRef atReferredType(@Nullable String atReferredType) {
