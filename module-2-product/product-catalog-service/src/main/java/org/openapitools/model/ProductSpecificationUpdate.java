...
@Schema(name = "ProductSpecification_Update", description = "Is a detailed description of a tangible or intangible object made available externally in the form of a ProductOffering to customers or other parties playing a party role. Skipped properties: id,href,lastUpdate")
...
public class ProductSpecificationUpdate {
  ...
  public ProductSpecificationUpdate brand(@Nullable String brand) {
    this.brand = brand;
    return this;
  }
  ...
  public ProductSpecificationUpdate description(@Nullable String description) {
  ...
  public ProductSpecificationUpdate isBundle(@Nullable Boolean isBundle) {
  ...
  public ProductSpecificationUpdate lifecycleStatus(@Nullable String lifecycleStatus) {
  ...
  public ProductSpecificationUpdate name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductSpecificationUpdate productNumber(@Nullable String productNumber) {
  ...
  public ProductSpecificationUpdate version(@Nullable String version) {
  ...
  public ProductSpecificationUpdate targetProductSchema(@Nullable TargetProductSchema targetProductSchema) {
  ...
  public ProductSpecificationUpdate validFor(@Nullable TimePeriod validFor) {
  ...
  public ProductSpecificationUpdate atBaseType(@Nullable String atBaseType) {
  ...
  public ProductSpecificationUpdate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductSpecificationUpdate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
